...
30.times do
  r = Restaurant.create(name: Faker::Name.name, description: Faker::Name.name, city_id: City.ids.sample)
  10.times do
    Item.create(name: Faker::Name.name, description: Faker::Name.name, cost: Faker::Number.number(digits: 2), restaurant: r)
  end
end